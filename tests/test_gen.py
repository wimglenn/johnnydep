...
def test_build_from_sdist(add_to_index):
    ...
    add_to_index(name="copyingmock", path=sdist_fname, urlfragment="#md5=9aa6ba13542d25e527fe358d53cdaf3b")
...
def test_plaintext_whl_metadata(add_to_index):
    ...
    add_to_index(name="testpath", path=sdist_fname, urlfragment="#md5=12728181294cf6f815421081d620c494")
...
def test_old_metadata_20(add_to_index):
    ...
    sha256 = 'bdcb144db3ba4beebbf5f8b249302560e8894bce6c3688dc79f587d6272ecea4'
    add_to_index(name='m20dist', path=whl_fname, urlfragment='#sha256='+sha256)
    ...
    assert jdist.metadata == expected_metadata
    assert jdist.checksum == 'sha256='+sha256
